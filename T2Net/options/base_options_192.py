...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--img_source_file', type=str, default='data/PLR-192x192_tra.txt',
                                 help='training and testing dataset for source domain')
        self.parser.add_argument('--img_target_file', type=str, default='data/DD1-192x192_tra.txt',
                                 help='training and testing dataset for target domain')
        self.parser.add_argument('--lab_source_file', type=str, default='data/PLD-192x192_tra.txt',
                                 help='training label for source domain')
        self.parser.add_argument('--lab_target_file', type=str, default='data/DD1-192x192_tra.txt',
        ...
        self.parser.add_argument('--loadSize', type=list, default=[192, 192],   #[192, 128], #[256,256], #
