...
class BaseOptions():
    ...
    def initialize(self):
        ...
        # data pattern define
        self.parser.add_argument('--img_source_file', type=str, default='data/iris_256x256/SYN-256_tra.txt', #'data/PLR-192x192_tra.txt'
                                 help='training and testing dataset for source domain')
        self.parser.add_argument('--img_target_file', type=str, default='data/iris_256x256/DD1-256_tra.txt', #'data/DD1-192x192_tra.txt'
                                 help='training and testing dataset for target domain')
        self.parser.add_argument('--lab_source_file', type=str, default='data/iris_256x256/DEP-256_tra.txt', #'data/PLD-192x192_tra.txt'
                                 help='training label for source domain')
        self.parser.add_argument('--lab_target_file', type=str, default='data/iris_256x256/DD1-256_tra.txt', #'data/DD1-192x192_tra.txt'
        ...
        self.parser.add_argument('--loadSize', type=list, default=[256, 256],   #[192, 192],
                                 help='load image into same size [192, 192]|[256, 192]|[256, 256]|[640, 192]')
        ...
        self.parser.add_argument('--nThreads', type=int, default=1,
                                 help='# threads for loading data')
        self.parser.add_argument('--shuffle', action='store_false',
        ...
        self.parser.add_argument('--trans_model_type', type=str, default='ResNet', #'ResNet'
        ...
        self.parser.add_argument('--dataset_root', type=str, default='', # default='../datasets/'
